...
public class Demo01Properties {
    ...
    private static void show03() throws IOException {
        ...
        //2.使用Properties集合对象中的方法load读取保存键值对的文件
        //prop.load(new FileInputStream("D:\\IdeaProjects\\basic-code\\prop.txt"));
        prop.load(new FileReader("D:\\IdeaProjects\\basic-code\\prop.txt"));
        //3.遍历Properties集合
    ...
    private static void show02() throws IOException {
        ...
        //2.创建字符输出流/字节输出流对象,构造方法中绑定要输出的目的地
        FileWriter fw = new FileWriter("D:\\IdeaProjects\\basic-code\\prop.txt");
        //3.使用Properties集合中的方法store,把集合中的临时数据,持久化写入到硬盘中存储
        prop.store(fw, "");
        //4.释放资源
        fw.close();
