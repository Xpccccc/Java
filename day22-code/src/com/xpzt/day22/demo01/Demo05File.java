...
public class Demo05File {
    ...
    private static void show03() {
        File f1 = new File("D:\\IdeaProjects\\basic-code\\a");
        boolean b1 = f1.delete();
        System.out.println("b1:" + b1);

        File f2 = new File("D:\\IdeaProjects\\basic-code\\111");
        System.out.println(f2.delete());

        File f3 = new File("D:\\IdeaProjects\\basic-co");
    ...
    private static void show02() {
        ...
        File f2 = new File("D:\\IdeaProjects\\basic-code\\111\\222\\333");
        boolean b2 = f2.mkdirs();
        System.out.println("b2:" + b2);

        File f3 = new File("D:\\IdeaProjects\\basic-code\\abc.txt");
    ...
    private static void show01() throws IOException {
        File f1 = new File("C:\\Users\\Xpzt\\1.txt");
        boolean b1 = f1.createNewFile();
        System.out.println(b1);

        File f2 = new File("Xpzt\\b.txt");
        System.out.println(f2.createNewFile());

        File f3 = new File("Xpzt\\新建文件夹");
